...
const PRODUCTS = [
  ...
  { id: 2, name: 'Retatrutide 20mg', category: 'Weight Loss', price: 140, currency: 'AUD', stock: 15, stripePriceId: 'price_1ThQ2aGuF9J8lg77Z2ZAaEOX', desc: 'High-dose triple agonist for extended metabolic research protocols.', specs: { 'Purity': '99%+', 'Amount': '20mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },
  { id: 5, name: '5-Amino-1MQ 5mg', category: 'Weight Loss', price: 40, currency: 'AUD', stock: 4, stripePriceId: 'price_1ThQ2cGuF9J8lg77k7JhGDzW', desc: 'NNMT inhibitor. Supports cellular energy metabolism and fat oxidation research.', specs: { 'Purity': '98%+', 'Amount': '5mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },

  // ========== RECOVERY ==========
  { id: 6, name: 'BPC-157 10mg', category: 'Recovery', price: 70, currency: 'AUD', stock: 8, badge: 'Popular', stripePriceId: 'price_1ThQ2gGuF9J8lg77meOWKT3j', desc: 'Body Protection Compound. Supports tissue repair, gut health, and angiogenesis research.', specs: { 'Purity': '99%+', 'Amount': '10mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },
  ...
  { id: 8, name: 'KPV 10mg', category: 'Recovery', price: 60, currency: 'AUD', stock: 5, stripePriceId: 'price_1ThQFVGuF9J8lg77hFaUfREJ', desc: 'Anti-inflammatory tripeptide derived from alpha-MSH. Supports gut health and inflammation research.', specs: { 'Purity': '98%+', 'Amount': '10mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },

  // ========== ANTI-AGING ==========
  { id: 9, name: 'GHK-Cu 50mg', category: 'Anti-Aging', price: 50, currency: 'AUD', stock: 8, stripePriceId: 'price_1ThQ2eGuF9J8lg77LWY8bq1a', desc: 'Copper peptide complex. Supports skin remodeling, collagen synthesis, and wound healing research.', specs: { 'Purity': '98%+', 'Amount': '50mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },
  { id: 19, name: 'GHK-Cu 100mg', category: 'Anti-Aging', price: 90, currency: 'AUD', stock: 9, stripePriceId: 'price_1ThQ2iGuF9J8lg775B4bjNqo', desc: 'High-dose copper peptide complex. Double concentration for extended skin remodeling and collagen synthesis research.', specs: { 'Purity': '98%+', 'Amount': '100mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },
  { id: 10, name: 'Glutathione 600mg', category: 'Anti-Aging', price: 70, currency: 'AUD', stock: 4, stripePriceId: 'price_1ThQ2YGuF9J8lg77rXKhmvEX', desc: 'Master antioxidant. Supports detoxification, immune function, and cellular protection research.', specs: { 'Purity': '99%+', 'Amount': '600mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },
  { id: 11, name: 'NAD+ 500mg', category: 'Anti-Aging', price: 70, currency: 'AUD', stock: 5, stripePriceId: 'price_1ThQFVGuF9J8lg77B7VqW59P', desc: 'Nicotinamide adenine dinucleotide. Essential coenzyme for cellular energy and longevity research.', specs: { 'Purity': '99%+', 'Amount': '500mg', 'Form': 'Lyophilized Powder', 'Storage': '-20°C', 'Research Use': 'In Vitro' } },
  { id: 12, name: 'MOTS-c 10mg', category: 'Anti-Aging', price: 80, currency: 'AUD', stock: 5, stripePriceId: 'price_1ThQFWGuF9J8lg77XBC3i41x', desc: 'Mitochondrial-derived peptide. Supports metabolic homeostasis and exercise mimetic research.', specs: { 'Purity': '98%+', 'Amount': '10mg', 'Form': 'Lyophilized Powder', 'Storage': '-20°C', 'Research Use': 'In Vitro' } },

  // ========== TANNING ==========
  { id: 13, name: 'Melanotan I 10mg', category: 'Tanning', price: 50, currency: 'AUD', stock: 4, stripePriceId: 'price_1ThQ2XGuF9J8lg772uljWuyS', desc: 'Alpha-melanocyte stimulating hormone analog. Supports melanogenesis and skin pigmentation research.', specs: { 'Purity': '99%+', 'Amount': '10mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },
  { id: 14, name: 'Melanotan II 10mg', category: 'Tanning', price: 50, currency: 'AUD', stock: 1, stripePriceId: 'price_1ThQ2dGuF9J8lg7759VPVoOd', desc: 'Melanocortin receptor agonist. Supports tanning response and melanin production research.', specs: { 'Purity': '99%+', 'Amount': '10mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },

  // ========== COGNITIVE ==========
  { id: 15, name: 'Selank', category: 'Cognitive', price: 60, currency: 'AUD', stock: 10, stripePriceId: 'price_1ThQ2bGuF9J8lg77YjPbZ3kp', desc: 'Synthetic tuftsin analog. Supports anxiolytic, nootropic, and immune modulation research.', specs: { 'Purity': '98%+', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },
  { id: 16, name: 'Semax', category: 'Cognitive', price: 60, currency: 'AUD', stock: 10, stripePriceId: 'price_1ThQ2hGuF9J8lg77RxgnUU0u', desc: 'Synthetic ACTH analog. Supports cognitive enhancement, neuroprotection, and focus research.', specs: { 'Purity': '98%+', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },

  // ========== SUPPLIES ==========
  { id: 17, name: 'Bac Water 3ml', category: 'Supplies', price: 10, currency: 'AUD', stock: 5, stripePriceId: 'price_1ThQ2fGuF9J8lg77UgU13BZW', desc: 'Bacteriostatic water for reconstitution. Contains 0.9% benzyl alcohol preservative.', specs: { 'Volume': '3ml', 'Preservative': '0.9% Benzyl Alcohol', 'Storage': 'Room Temperature', 'Sterile': 'Yes' } },
  { id: 18, name: 'Bac Water 10ml', category: 'Supplies', price: 15, currency: 'AUD', stock: 10, stripePriceId: 'price_1ThQ2cGuF9J8lg77H2EUKglQ', desc: 'Bacteriostatic water for reconstitution. Larger volume for multiple uses.', specs: { 'Volume': '10ml', 'Preservative': '0.9% Benzyl Alcohol', 'Storage': 'Room Temperature', 'Sterile': 'Yes' } },
];
