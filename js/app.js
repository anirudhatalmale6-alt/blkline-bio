...
const PRODUCTS = [
  ...
  { id: 5, name: '5-Amino-1MQ 5mg', category: 'Weight Loss', price: 40, currency: 'AUD', stock: 10, stripePriceId: 'price_1ThQ2cGuF9J8lg77k7JhGDzW', image: 'images/products/5-amino-1mq.jpg', desc: 'NNMT inhibitor. Supports cellular energy metabolism and fat oxidation research.', specs: { 'Purity': '98%+', 'Amount': '5mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },

  // ========== RECOVERY ==========
  { id: 6, name: 'BPC-157 10mg', category: 'Recovery', price: 70, currency: 'AUD', stock: 10, badge: 'Popular', stripePriceId: 'price_1ThQ2gGuF9J8lg77meOWKT3j', image: 'images/products/bpc-157.jpg', desc: 'Body Protection Compound. Supports tissue repair, gut health, and angiogenesis research.', specs: { 'Purity': '99%+', 'Amount': '10mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },
  ...
  // ========== TANNING ==========
  { id: 13, name: 'Melanotan I 10mg', category: 'Tanning', price: 50, currency: 'AUD', stock: 10, stripePriceId: 'price_1ThQ2XGuF9J8lg772uljWuyS', image: 'images/products/melanotan-1.jpg', desc: 'Alpha-melanocyte stimulating hormone analog. Supports melanogenesis and skin pigmentation research.', specs: { 'Purity': '99%+', 'Amount': '10mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },
  { id: 14, name: 'Melanotan II 10mg', category: 'Tanning', price: 50, currency: 'AUD', stock: 10, stripePriceId: 'price_1ThQ2dGuF9J8lg7759VPVoOd', image: 'images/products/melanotan-2.jpg', desc: 'Melanocortin receptor agonist. Supports tanning response and melanin production research.', specs: { 'Purity': '99%+', 'Amount': '10mg', 'Form': 'Lyophilized Powder', 'Storage': '2-8°C', 'Research Use': 'In Vitro' } },
  ...
  // ========== SUPPLIES ==========
  { id: 17, name: 'Bac Water 3ml', category: 'Supplies', price: 10, currency: 'AUD', stock: 20, stripePriceId: 'price_1ThQ2fGuF9J8lg77UgU13BZW', image: 'images/products/bac-water-3ml.jpg', desc: 'Bacteriostatic water for reconstitution. Contains 0.9% benzyl alcohol preservative.', specs: { 'Volume': '3ml', 'Preservative': '0.9% Benzyl Alcohol', 'Storage': 'Room Temperature', 'Sterile': 'Yes' } },
  { id: 18, name: 'Bac Water 10ml', category: 'Supplies', price: 15, currency: 'AUD', stock: 20, stripePriceId: 'price_1ThQ2cGuF9J8lg77H2EUKglQ', desc: 'Bacteriostatic water for reconstitution. Larger volume for multiple uses.', specs: { 'Volume': '10ml', 'Preservative': '0.9% Benzyl Alcohol', 'Storage': 'Room Temperature', 'Sterile': 'Yes' } },
];
